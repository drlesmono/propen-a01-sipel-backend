        ...
        return (
            <Router>
                <Layout>
                        ...
                        <Navbar.Collapse id="responsive-navbar-nav">
                            <Nav className="mr-auto">
                                ...
                                <NavDropdown title="Produksi" id="collasible-nav-dropdown">
                                    <NavDropdown.Item ><Link to="" style={{ textDecoration: 'none' }}>Penugasan</Link></NavDropdown.Item>
                                    <NavDropdown.Item><Link to="" style={{ textDecoration: 'none' }}>Progress Delivery</Link></NavDropdown.Item>
                                    <NavDropdown.Item><Link to="" style={{ textDecoration: 'none' }}>Periode Kontrak</Link></NavDropdown.Item>
                                    <NavDropdown.Item><Link to="" style={{ textDecoration: 'none' }}>Maintenance</Link></NavDropdown.Item>
                        ...
                        <Nav.Item>
                            ...
                            Disabled
                                ...
                                <NavDropdown title="Laporan" id="collasible-nav-dropdown">
                                    <NavDropdown.Item href="/laporan/create-bast">Generate BAST</NavDropdown.Item>
                                    <NavDropdown.Item href="/laporan/list">Daftar Laporan</NavDropdown.Item>
                                </NavDropdown>
                    ...
                    <Switch>
                        <Route path="/laporan/list">
                            <Laporan/>
                        </Route>
                        <Route path="/laporan/create-bast">
                            <Bast/>
                        </Route>
                        <Route path="/">
                            <div>
